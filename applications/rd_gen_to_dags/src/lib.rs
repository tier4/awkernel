...
const DAG_FILE_0: &str = concat!(include_str!("/home/nokosan/azumi-lab/RD-Gen/test/custom/dag_pub2.yaml"), "\n");
const DAG_FILE_1: &str = concat!(include_str!("/home/nokosan/azumi-lab/RD-Gen/test/custom/dag_pub4.yaml"), "\n");
const DAG_FILE_2: &str = concat!(include_str!("/home/nokosan/azumi-lab/RD-Gen/test/custom/dag_pub6.yaml"), "\n");
