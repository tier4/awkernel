...
async fn simple_consistency_test() {
    ...
    info!("Test 1: Simple sequential test");
    {
        ...
        let mut file = file_path
            .create_file()
            .await
            .expect("Failed to create test1");
        file.write(b"Test 1 data")
            .await
    ...
    info!("Test 2: Two handles, close in order");
    {
        ...
        let mut file1 = file_path
            .create_file()
            .await
            .expect("Failed to create test2 handle 1");
        file1
            .write(b"Handle 1 data")
            .await
            .expect("Failed to write with handle 1");

        // Create second handle while first is still open
        let file2 = file_path
            .create_file()
            .await
            .expect("Failed to create test2 handle 2");
    ...
    info!("Test 3: Sequential handles");
    {
        ...
        let mut file1 = file_path
            .create_file()
            .await
            .expect("Failed to create test3 handle 1");
        file1
            .write(b"First write")
            .await
