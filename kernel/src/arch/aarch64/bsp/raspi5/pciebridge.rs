...
pub fn init_pcie_bridge() {
    ...
    let init_status = unsafe { pcie_host_bridge.pcie_init() };

    awkernel_lib::delay::wait_microsec(100000);
    let bridge_status = pcie_host_bridge.enable_bridge();
    awkernel_lib::delay::wait_microsec(100000);
    awkernel_lib::delay::wait_microsec(100000);
    let device_status = pcie_host_bridge.enable_device(0x20000, 0, 0);
    awkernel_lib::delay::wait_microsec(100000);
}
