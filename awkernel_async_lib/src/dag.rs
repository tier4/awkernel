...
pub mod test_utils {
    ...
    pub async fn test_spawn_reactor<F, Args, Ret>(
        reactor_name: Cow<'static, str>,
        f: F,
        subscribe_topic_names: Vec<Cow<'static, str>>,
        publish_topic_names: Vec<Cow<'static, str>>,
    ...
    pub async fn test_spawn_periodic_reactor<F, Ret>(
        reactor_name: Cow<'static, str>,
        f: F,
        publish_topic_names: Vec<Cow<'static, str>>,
        sched_type: SchedulerType,
    ...
    where
        ...
        Ret::Publishers: Send,
    {
        spawn_periodic_reactor::<F, Ret>(reactor_name, f, publish_topic_names, sched_type, period)
            .await
    }

    pub async fn test_spawn_sink_reactor<F, Args>(
        reactor_name: Cow<'static, str>,
        f: F,
        subscribe_topic_names: Vec<Cow<'static, str>>,
        sched_type: SchedulerType,
    ...
    where
        ...
        Args::Subscribers: Send,
    {
        spawn_sink_reactor::<F, Args>(reactor_name, f, subscribe_topic_names, sched_type).await
    }
}
