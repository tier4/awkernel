//! Mount-aware AsyncVfsPath implementation
//!
//! This module provides a mount-aware version of AsyncVfsPath that automatically
//! resolves filesystems from the VFS registry based on mount points.
...
/// A mount-aware virtual filesystem path
#[derive(Clone, Debug)]
...
impl PathLike for MountAwareAsyncVfsPath {
    fn get_path(&self) -> String {
        self.path.clone()
    }
}

impl PartialEq for MountAwareAsyncVfsPath {
    fn eq(&self, other: &Self) -> bool {
        self.path == other.path
    }
}

impl Eq for MountAwareAsyncVfsPath {}

impl MountAwareAsyncVfsPath {
