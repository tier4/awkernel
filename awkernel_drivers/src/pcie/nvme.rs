...
impl Nvme {
    ...
    pub fn read_sectors(
        ...
        // IMPORTANT: We must not hold the write lock while waiting for interrupts
        // to avoid deadlock with the interrupt handler
        ...
        if poll {
            ...
            // For interrupt mode, we need to be more careful about locking
            // Get a CCB first
            let ccb_id = {
